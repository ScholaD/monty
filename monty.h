...
int execute(char *content, stack_t **stack, unsigned int current, FILE *file);
void f_pint(stack_t **head, unsigned int current);
void f_pop(stack_t **head, unsigned int current);
void f_swap(stack_t **head, unsigned int current);
void f_add(stack_t **head, unsigned int current);
void f_nop(stack_t **head, unsigned int current);
#endif
